...
* **Улучшение умной компиляции:** Теперь вы можете конвертировать файлы прямо в Windows Explorer (Проводник), просто наведя на них фокус, без необходимости копировать их в буфер обмена (Ctrl+C). Программа автоматически определит путь к файлу.
